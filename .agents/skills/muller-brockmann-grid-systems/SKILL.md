...
- **Palette.** Pure white paper, near-black ink, **one accent — red is canonical**. Avoid the warm-cream "Codex look"; **never blue/purple gradients** (hard house rule).
...
- **Palette:** white `#fff`, ink `#111`, one accent (Swiss red `#e4002b`). No warm-cream Codex look; no blue/purple gradients.
